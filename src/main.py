...
• JSON artefacts must be written into ``.research/iteration54/``
• Any generated images must live inside     ``.research/iteration54/images``
"""
...
ARTEFACT_DIR = ROOT / ".research" / "iteration54"  # <-- UPDATED from iteration53 → 54
