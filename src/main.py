...
• JSON artefacts must be written into ``.research/iteration63/``
• Any generated images must live inside     ``.research/iteration63/images``
"""
...
ARTEFACT_DIR = ROOT / ".research" / "iteration63"  # <-- updated to iteration63
