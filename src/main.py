...
• JSON artefacts must be written into ``.research/iteration55/``
• Any generated images must live inside     ``.research/iteration55/images``
"""
...
ARTEFACT_DIR = ROOT / ".research" / "iteration55"  # <-- UPDATED to iteration55
