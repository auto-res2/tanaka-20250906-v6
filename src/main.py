...
• JSON artefacts must be written into ``.research/iteration59/``
• Any generated images must live inside     ``.research/iteration59/images``
"""
...
ARTEFACT_DIR = ROOT / ".research" / "iteration59"  # <-- updated to iteration59
