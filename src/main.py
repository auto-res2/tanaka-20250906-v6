...
• JSON artefacts must be written into ``.research/iteration53/``
• Any generated images must live inside     ``.research/iteration53/images``
"""
...
ARTEFACT_DIR = ROOT / ".research" / "iteration53"  # <-- UPDATED to iteration53
