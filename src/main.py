...
• JSON artefacts must be written into ``.research/iteration65/``
• Any generated images must live inside     ``.research/iteration65/images``
"""
...
ARTEFACT_DIR = ROOT / ".research" / "iteration65"  # <-- UPDATED from iteration64 → iteration65
