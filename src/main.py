...
• JSON artefacts must be written into ``.research/iteration64/``
• Any generated images must live inside     ``.research/iteration64/images``
"""
...
ARTEFACT_DIR = ROOT / ".research" / "iteration64"  # <-- UPDATED to iteration64
