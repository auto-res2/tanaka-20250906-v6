...
• JSON artefacts must be written into ``.research/iteration57/``
• Any generated images must live inside     ``.research/iteration57/images``
"""
...
ARTEFACT_DIR = ROOT / ".research" / "iteration57"  # <-- updated to iteration57
