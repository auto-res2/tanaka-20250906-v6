...
• JSON artefacts must be written into ``.research/iteration56/``
• Any generated images must live inside     ``.research/iteration56/images``
"""
...
ARTEFACT_DIR = ROOT / ".research" / "iteration56"  # <-- updated to iteration56
