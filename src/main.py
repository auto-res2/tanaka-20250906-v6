...
• JSON artefacts must be written into ``.research/iteration66/``
• Any generated images must live inside     ``.research/iteration66/images``
"""
...
ARTEFACT_DIR = ROOT / ".research" / "iteration66"  # <-- updated to match mandatory path
