...
• JSON artefacts must be written into ``.research/iteration60/``
• Any generated images must live inside     ``.research/iteration60/images``
"""
...
ARTEFACT_DIR = ROOT / ".research" / "iteration60"  # <-- updated to iteration60
