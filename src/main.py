...
• JSON artefacts must be written into ``.research/iteration58/``
• Any generated images must live inside     ``.research/iteration58/images``
"""
...
ARTEFACT_DIR = ROOT / ".research" / "iteration58"  # <-- updated to iteration58
